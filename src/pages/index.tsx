  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HRManagementApplication - Your ultimate solution for seamless HR operations and strategic talent management. Streamlining your HR processes has never been easier!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HRManagementApplication - Your ultimate solution for seamless HR operations and strategic talent management. Streamlining your HR processes has never been easier!`}
            </Text>
            <Box
